...
public class Ejercicio03 {
    public static void main(String[] args) {
        ...
        // PROCESO
        System.out.println("Elige un color para la campaña publicitaria (celeste, morado, turquesa)");
        for (int i = 1; i <= 10; i++) {
            ...
            switch (color.toLowerCase()) {
                ...
                case "turquesa":
                    ...
                    break;
                default:
                    System.out.println("El color que ingresó no es válido, inténtelo de nuevo");
                    i--;
                    break;
            }
        }
